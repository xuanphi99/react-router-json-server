...
export default class ReactBook extends Component {
    ...
    componentDidMount() {
        BookService.getBookByCategory(BookConstant.REACT_BOOK)
            .then((res) => {
                this.setState({
                    books: res.data ,
        ...
        callAPIPagination = (nextProps) => {
            BookService.paginationPage(BookConstant.REACT_BOOK,nextProps,  BookConstant.TOTAL_PAGE_LIMIT)
            .then((res) => {
                this.setState({
